        ...
        <div>
            <div className='box'>
                <div className='boxtex'>
                    ...
                    <h2 className='text-center'>Discover our handpicked selection of premium properties</h2>
                </div>
                ...
                <div className='box1 d-flex flex-wrap justify-content-center gap-5 w-100 p-3'>
                    <div className="card" style={{ width: "25rem" }}>
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text d-flex gap-3 mt-3">
                                <i class="fa-solid fa-location-dot"></i>
                                <h6>Connaught Place, New Delhi</h6>
                            </p>

                            <div className='boxtx3 d-flex justify-content-around'>
                                <p><i class="fa-solid fa-bed"></i>3 Beds</p>
                                <p><i class="fa-solid fa-bath"></i>2 Baths</p>
                                <p><i class="fa-regular fa-square"></i>1,200 sq ft</p>
                            </div>
                    ...
                    <div className="card border border-2" style={{ width: "25rem" }}>
                        ...
                        <div className="card-body">
                            ...
                            <div className='boxtx3 d-flex justify-content-around'>
                                ...
                                <p><i class="fa-solid fa-bath"></i>3 Baths</p>
                                <p><i class="fa-regular fa-square"></i>2,500 sq ft</p>
                            </div>
                    ...
                    <div className="card" style={{ width: "25rem" }}>
                        ...
                        <div className="card-body">
                            ...
                            <div className='boxtx3 d-flex justify-content-around'>
                                <p><i class="fa-solid fa-bed"></i>5 Beds</p>
                                <p><i class="fa-solid fa-bath"></i>4 Baths</p>
                                <p><i class="fa-regular fa-square"></i>3,200 sq ft</p>
                            </div>
